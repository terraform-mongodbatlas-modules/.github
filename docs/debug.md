...
| Module default, variable validation, submodule wiring, or documented module behavior | Module repo in the [organization profile repository table](../profile/README.md#repositories) | That module's GitHub issues |
...
| Wrong link, template, or documentation in this repository | This repository | Issues in `.github` |
...
- [Organization profile repository table](../profile/README.md#repositories)
